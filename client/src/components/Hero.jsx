...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen w-ful flex flex-col items-center justify-center overflow-hidden bg-black">
      <div className="w-full absolute inset-0 h-screen bg-gradient-to-b from-black via-purple-900/20 to-black"></div>
      ...
      <div className="relative z-10 text-center px-6 md:px-10 py-10 md:py-24 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-pink-400">make it burn</span>.
        </motion.p>
      ...
      >
        <span className="text-pink-400 text-sm mb-2 font-medium">
          Discover More
        </span>
