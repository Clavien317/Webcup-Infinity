...
const toneOptions = [
  {
    ...
    label: "Dramatic",
    icon: "🎭",
    description: "Intense and theatrical moments",
  },
  {
    value: "ironic",
    label: "Ironic",
    icon: "😏",
    description: "With a touch of sarcasm",
  },
  {
    value: "ultra-cringe",
    label: "Ultra Cringe",
  ...
  },
  {
    ...
    label: "Touching",
    icon: "💝",
    description: "Heart-warming and moving",
  },
  {
    value: "absurd",
    label: "Absurd",
    icon: "🤪",
    description: "Quirky and unexpected",
  },
  {
    value: "passive-aggressive",
    label: "Passive-Aggressive",
    icon: "🙃",
    description: "Subtly pointed",
  },
  {
    value: "honest",
    label: "Honest",
    icon: "💫",
    description: "Straightforward and genuine",
  },
];
...
const mockResponse = {
  ...
  content: (formData) => ({
    intro: `As I sit here reflecting on this ${
      formData.tone
    } moment, my heart is filled with ${
      formData.scenario.includes("heartbreak")
        ? "bittersweet memories"
        : "mixed emotions"
    }.`,
    body:
      formData.message ||
      "Time has a way of bringing change into our lives, sometimes expected, sometimes not. But each ending is also a new beginning.",
                          ...
                          <motion.button
                            ...
                            className={`btn btn-outline absolute ${
                              selectedEmotion?.name === emotion.name
                                ? "btn-primary ring ring-primary ring-offset-2"
                                : ""
                            }`}
                            style={{
                              left: `calc(43.5% + ${x}px)`,
                      ...
                      {[
                        {
                          ...
                          icon: "💔",
                          description:
                            "Saying goodbye to a relationship or romantic partner",
                        },
                        {
                          id: "family-friends",
                          ...
                          icon: "👥",
                          description:
                            "Farewell to loved ones, moving away from family or friends",
                        },
                        {
                          id: "career",
                          title: "Career & Work",
                          icon: "💼",
                          description:
                            "Leaving a job, project, or workplace you loved",
                        },
                        {
                          id: "life-chapter",
                          title: "Life Chapter",
                          icon: "📖",
                          description:
                            "Closing a significant chapter in your life",
                        },
                        {
                          id: "other",
                          ...
                          icon: "✨",
                          description:
                            "Create a custom farewell for another situation",
                        },
                      ].map((scenario) => (
                        <motion.li
                          key={scenario.id}
                  ...
                  <div>
                    <div className="flex flex-col items-center mb-8 text-center">
                      ...
                      <p className="text-base-content/70">
                        This is your moment to express everything you need to
                        say
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="form-control">
                          ...
                          <label className="label">
                            <span className="label-text-alt">
                              Add background music to enhance your story
                            </span>
                          </label>
                        </div>
                      </div>
                ...
                {step === 4 && (
                  <div>
                    <div className="flex flex-col items-center mb-8 text-center">
                      ...
                      <p className="text-base-content/70">
                        Choose how you want your farewell to sound
                      </p>
                    </div>
                        ...
                        <div className="card-body">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  formData.includeGifs ? "" : "opacity-50"
                                }
                              >
                                GIFs
                              </span>
                            ...
                            <li className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  formData.includeSounds ? "" : "opacity-50"
                                }
                              >
                                Sound Effects
                              </span>
                            ...
                            <li className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  formData.includeAnimations ? "" : "opacity-50"
                                }
                              >
                                Animations
                              </span>
