      ...
      {items.map((item, idx) => (
        <a
          ...
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-base-200 block rounded-3xl"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-base-300 border border-transparent relative z-20",
        className
      )}>
